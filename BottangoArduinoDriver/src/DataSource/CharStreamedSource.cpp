...
void CharStreamedSource::checkTimeout()
{
...
bool CharStreamedSource::tryConsumeData(char** out)
{
...
void CharStreamedSource::resetBuffer()
{
	_serialCommandIdx = 0;
	_serialCommandBuffer[_serialCommandIdx] = '\0';
	_validDataAvailable = false;
...
bool CharStreamedSource::checkHash(const char* cmdString)
{
	if (cmdString[0] == '\0')
	{
		return 0;
