...
I2SAudioEffector::I2SAudioEffector(char* identifier, char* hash, IAudioPlayback* interface) : AbstractEffector(0, 1)
{
	...
	// ToDo: Why do we copy the identifier into "myIdentifier" and then immediately read it back out into "effectorIdentifier"? Why not just use "identifier" directly?
